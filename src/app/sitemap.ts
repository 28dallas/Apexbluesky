...
export default function sitemap(): MetadataRoute.Sitemap {
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${SITE_URL}/store`,              lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.95 },
        { url: `${SITE_URL}/store#hy300-projector`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    ];
