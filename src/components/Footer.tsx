...
import { Shield, MessageSquarePlus, Phone, Mail } from 'lucide-react';
                ...
                <div className={styles.footerGrid}>
                    <div className={styles.footerCol}>
                        ...
                        <p className={styles.footerValueProp}>
                            The ultimate precision-engineered utility hub. 53+ professional tools for developers, students, and creators. All 100% free.
                        </p>
